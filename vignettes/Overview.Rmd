...
- GitHub dev-site [https://github.com/blaiseratcliffe/breedR](https://github.com/blaiseratcliffe/breedR)
...
- This is a fork of the original [famuvie/breedR](https://github.com/famuvie/breedR).
  The genomic, Gibbs sampling and RENUMF90 features described in the package
  README are only in the fork.
...
- [Issues page](https://github.com/blaiseratcliffe/breedR/issues)
    - Bug reports
    - Feature requests

- [Wiki pages](https://github.com/famuvie/breedR/wiki) (upstream project)
    - Guides, tutorials, FAQ
    - Still the best reference for the core models; predates the fork's additions

- Mailing list [http://groups.google.com/group/breedr](http://groups.google.com/group/breedr) (upstream project)
